...
insert into projects (pmEmployeeId, name, description, product, projectStartDate, projectDuration, skills, createdAt, updatedAt) values (212000003, "testProj", "Just testing","the product", "2018-12-19", 2, "java", now(), now());
insert into projects (pmEmployeeId, name, description, product, projectStartDate, projectDuration, skills, createdAt, updatedAt) values (212000003, "Yet another project", "Another project testing","wow product", "2018-12-19", 3, "javascript", now(), now());
insert into projects (pmEmployeeId, name, description, product, projectStartDate, projectDuration, skills, createdAt, updatedAt) values (212000003, "Superb project", "Just testing","the product", "2018-12-19", 1, "SQL, java, javascript", now(), now());
...
values (212000000, "jay", "cha", "Employee", "212000005", "jay.cha@ge.com", "19175354837",  now(), now());
insert into users (employeeID, firstName, lastName, currentPosition, managerID,  email, phone,  createdAt, updatedAt)
values (212000001, "ronald", "chaudry", "Employee", "212000005", "ronald.chaudry@ge.com", null, now(), now());
insert into users (employeeID, firstName, lastName, currentPosition, managerID, email, phone, createdAt, updatedAt)
values (212000003, "siraj", "mohamed", "Employee", "212000005", "siraj.mohamed@ge.com", "14707799475", now(), now());
insert into users (employeeID, firstName, lastName, currentPosition, managerID, email, phone, createdAt, updatedAt)
